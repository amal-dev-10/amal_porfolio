          ...
          >
            ...
            <div className="glass-card rounded-2xl p-6 font-mono text-sm">
              ...
              <div className="flex flex-col gap-1.5 text-sm leading-relaxed">
                ...
                <span className="text-gray-400 pl-4">experience: <span className="text-emerald-400">6</span>,</span>
                ...
                <span className="text-amber-300 pl-8">"Enterprise Apps"</span><span className="text-gray-400">,</span>
                <span className="text-amber-300 pl-8">"GIS Solutions"</span><span className="text-gray-400">,</span>
                <span className="text-amber-300 pl-8">"AI Systems"</span><span className="text-gray-400">,</span>
                <span className="text-amber-300 pl-8">"Mobile Apps"</span>
          ...
          >
            <div className="flex flex-col gap-5">
              ...
              <p className="text-gray-400 leading-relaxed text-base">
                ...
                <span className="text-cyan-300">GIS mapping platforms</span>, intelligent{' '}
                <span className="text-purple-300">AI chatbot systems</span>, and cross-platform{' '}
                <span className="text-emerald-300">mobile apps</span>.
              </p>
              <p className="text-gray-400 leading-relaxed text-base">
                I specialize in <strong className="text-white">Vue.js</strong> and <strong className="text-white">React</strong> on the frontend, <strong className="text-white">Node.js</strong> on the backend, with expertise in <strong className="text-white">PostgreSQL</strong>, <strong className="text-white">Docker</strong>, and modern DevOps practices.
              </p>
              <p className="text-gray-400 leading-relaxed text-base">
